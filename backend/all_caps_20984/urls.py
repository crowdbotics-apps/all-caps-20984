"""all_caps_20984 URL Configuration
...
admin.site.site_header = "ALL CAPS"
admin.site.site_title = "ALL CAPS Admin Portal"
admin.site.index_title = "ALL CAPS Admin"

# swagger
api_info = openapi.Info(
    title="ALL CAPS API",
    default_version="v1",
    description="API documentation for ALL CAPS App",
)
